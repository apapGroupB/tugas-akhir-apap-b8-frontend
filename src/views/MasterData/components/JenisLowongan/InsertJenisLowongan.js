...
import { Modal, Title, ColumnContainer, ButtonContainer } from './InsertJenisLowongan.style'
...
const InsertJenisLowongan = props => {
  const { toggle } = props;
  ...
  return (
    ...
    >
      <Modal>
      <div>
      <Title>{'Tambah Jenis Lowongan'}</Title>
...
export default InsertJenisLowongan;
