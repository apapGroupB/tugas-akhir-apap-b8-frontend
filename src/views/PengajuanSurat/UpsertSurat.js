...
const DeleteSurat = props => {
  ...
  //   props.allCookies.user.uuid === dataState.uuid_user ?
  //   true :
  //     false)
  ...
  //         <Select
  //           disabled={actionType === 'Tambah' || isOwner ? false : true} 
  ...
  //         <Select
  //           disabled={isOwner ||
  //             (isApprover && dataState.status === 0) ||
  //             (isAdmin && dataState.status === 2)
  //             ? false : true}
  //           labelId="demo-simple-select-label"
  //           id="status"
  ...
  //           <KeyboardDatePicker
  //               disableToolbar
  //               disabled={actionType === 'Tambah' ? false : true}
  //               variant="inline"
  //               format="MM/dd/yyy"
  //               margin="normal"
